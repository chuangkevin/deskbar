...
_PCT_FIELDS = ("session_pct", "weekly_pct", "fable_pct", "ag_5h_pct", "ag_weekly_pct", "oa_weekly_pct", "cu_pct", "og_5h_pct", "og_weekly_pct")
_RESETS_FIELDS = ("session_resets_at", "weekly_resets_at", "fable_resets_at", "ag_5h_resets_at", "ag_weekly_resets_at", "oa_weekly_resets_at", "cu_resets_at", "og_5h_resets_at", "og_weekly_resets_at")
_USAGE_FETCHED_FIELDS = ("fetched_at", "claude_fetched_at", "ag_fetched_at", "oa_fetched_at", "cu_fetched_at", "og_fetched_at")
_MAX_OA_ACCOUNTS = 8
...
def validate_oa_accounts_payload(value) -> tuple[bool, str | None]:
    if value is None:
        return True, None
    if not isinstance(value, list):
        return False, "invalid oa_accounts"
    if len(value) > _MAX_OA_ACCOUNTS:
        return False, "invalid oa_accounts"
    for item in value:
        ...
        if not _valid_pct(item.get("weekly_pct")):
            return False, "invalid oa_accounts"
        for field in ("weekly_resets_at", "fetched_at"):

...
class OgAccount:
    ...
    monthly_resets_at: datetime | None
...
class UsageInfo:
    ...
    cc_5h_pct: float | None = None
    cc_5h_resets_at: datetime | None = None
    cc_weekly_pct: float | None = None
    cc_weekly_resets_at: datetime | None = None
    cc_fetched_at: datetime | None = None
    cc_billing_at: datetime | None = None
    cu_billing_at: datetime | None = None
    og_fetched_at: datetime | None = None
    oa_accounts: tuple[OaAccount, ...] = ()
    cc_accounts: tuple[CcAccount, ...] = ()
    og_accounts: tuple[OgAccount, ...] = ()
...
WINDOW_S = {"session": 5 * 3600, "weekly": 7 * 86400, "fable": 7 * 86400, "ag_5h": 5 * 3600, "ag_weekly": 7 * 86400, "oa_weekly": 7 * 86400, "cu": 30 * 86400, "cc_5h": 5 * 3600, "cc_weekly": 7 * 86400, "og_5h": 5 * 3600, "og_weekly": 7 * 86400, "og_monthly": 30 * 86400}
